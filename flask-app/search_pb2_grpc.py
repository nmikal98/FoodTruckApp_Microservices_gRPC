...
class searchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SearchStore = channel.unary_unary(
                ...
                request_serializer=search__pb2.searchRequest.SerializeToString,
                response_deserializer=search__pb2.searchStoreResponse.FromString,
                )
...
def add_searchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SearchStore': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=search__pb2.searchRequest.FromString,
                    response_serializer=search__pb2.searchStoreResponse.SerializeToString,
            ),
    }
...
class searchService(object):
    ...
    def SearchStore(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/searchService/SearchStore',
            search__pb2.searchRequest.SerializeToString,
            search__pb2.searchStoreResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
